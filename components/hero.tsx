...
export default function Hero() {
    ...
    const ctx = gsap.context(() => {
      ...
      if (title) {
        ...
        title.innerHTML = text
          .split("")
          .map((char) => (char === " " ? " " : `<span class="split-char">${char}</span>`))
          .join("")
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ref={overlayRef}
        className="absolute inset-0 bg-gradient-to-b from-aldees-black/70 via-aldees-black/50 to-aldees-black opacity-70"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-aldees-black/80 via-transparent to-aldees-black/80" />
      ...
      >
        ...
        <div className="mb-8 overflow-hidden">
          <p className="text-aldees-yellow/80 text-sm md:text-base tracking-[0.4em] uppercase font-medium">
        ...
        <h1
          ref={titleRef}
          className="text-6xl md:text-8xl lg:text-9xl font-bold text-aldees-offwhite mb-8 tracking-tight leading-none glow-yellow"
        ...
        >
          Bold flavors crafted with passion. Every dish tells a story of quality, tradition, and the relentless pursuit
