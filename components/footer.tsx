...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative bg-aldees-black overflow-hidden">
      <div className="h-1 bg-linear-to-r from-transparent via-aldees-yellow to-transparent" />
      ...
      <div ref={contentRef} className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              <img
                src="/navbar_logo.png"
                alt="ALDEE'S Logo"
                className="w-42 h-40 object-contain absolute -top-10"
              />
            </div>

            <p className="text-aldees-offwhite/60 max-w-md mb-8 leading-relaxed mt-24">
              Bold flavors crafted with passion. Every dish tells a story of
              quality, tradition, and the relentless pursuit of culinary
              excellence.
            </p>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-aldees-yellow text-sm font-bold mb-6 tracking-[0.2em] uppercase">
              Navigation
            </h4>
              ...
              {footerLinks.navigation.map((link) => (
                <li key={link.label}>
                  <Link
                    ...
                    <span className="w-0 h-px bg-aldees-yellow group-hover:w-4 transition-all duration-300" />
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-16 pt-12 border-t border-aldees-yellow/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
              ...
              <p className="text-aldees-offwhite/50">
      ...
      <div className="border-t border-aldees-yellow/10">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-aldees-offwhite/40 text-sm">
              © 2025 ALDEE'S. All rights reserved.
            </p>
            <p className="text-aldees-offwhite/40 text-sm flex items-center gap-2">
              Made with <span className="text-red-500">♥</span> for flavor
              lovers
            </p>
          </div>
        </div>
      ...
      <div
        ...
        <div
          className="text-[20vw] font-bold text-aldees-yellow/3 leading-none whitespace-nowrap translate-y-1/4"
          style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
