...
const galleryImages = {
  ambience: [
    { id: 1, src: "/luxury-restaurant-interior-vintage-lighting-warm-a.jpg", alt: "Restaurant Interior" },
    { id: 2, src: "/restaurant-bar-area-vintage-style-neon-lights-cock.jpg", alt: "Bar Area" },
    { id: 3, src: "/restaurant-dining-area-vintage-decor-brick-walls-c.jpg", alt: "Dining Area" },
    { id: 4, src: "/restaurant-outdoor-seating-patio-evening-lights-ro.jpg", alt: "Outdoor Seating" },
    { id: 5, src: "/private-dining-room-elegant-chandelier-intimate.jpg", alt: "Private Dining" },
    { id: 6, src: "/restaurant-entrance-vintage-signage-neon-night.jpg", alt: "Restaurant Entrance" },
  ],
  food: [
    { id: 7, src: "/gourmet-burger-cheese-melting-premium-food-photogr.jpg", alt: "Signature Burger" },
    { id: 8, src: "/crispy-chicken-wings-golden-sauce-food-photography.jpg", alt: "Crispy Wings" },
    { id: 9, src: "/truffle-mac-and-cheese-creamy-premium-food-photogr.jpg", alt: "Truffle Mac & Cheese" },
    { id: 10, src: "/placeholder.svg?height=600&width=800", alt: "BBQ Pulled Pork" },
    { id: 11, src: "/placeholder.svg?height=600&width=800", alt: "Loaded Fries" },
    { id: 12, src: "/placeholder.svg?height=600&width=800", alt: "Classic Milkshake" },
    { id: 13, src: "/placeholder.svg?height=600&width=800", alt: "Nashville Hot Chicken" },
    { id: 14, src: "/placeholder.svg?height=600&width=800", alt: "Breakfast Stack" },
  ],
}
...
export default function GallerySection() {
  ...
  const navigateLightbox = (direction: "prev" | "next") => {
    ...
    const newIndex =
      direction === "prev"
        ? (lightboxImage.index - 1 + currentImages.length) % currentImages.length
      ...
      <div className="relative container mx-auto px-6 py-20">
        ...
        <div ref={headerRef} className="text-center mb-16">
          <p className="text-xl text-aldees-offwhite/60 max-w-3xl mx-auto leading-relaxed">
            Step inside ALDEE'S and experience the perfect blend of vintage charm and culinary excellence through our
            lens. Every corner tells a story, every dish is a masterpiece.
          </p>
        </div>
        ...
        <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {currentImages.map((image, index) => (
            ...
            >
              <div
                className={`relative ${index === 0 || index === 5 ? "aspect-square" : "aspect-[4/3]"} overflow-hidden`}
              >
                <img
                ...
                {/* Gradient Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-aldees-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500" />
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-aldees-yellow/90 rounded-full flex items-center justify-center opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500">
                  <svg className="w-6 h-6 text-aldees-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
